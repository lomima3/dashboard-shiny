fixedRow(
  column(12,
         ...
         tags$ol(
           ...
           tags$li(h4("Effectuez un prétraitement des données dans le volet \"prétraitement\" après Soumission.")), 
           tags$li(h4("Consultez la structure des données dans l'onglet \"Structure des Données\".")),
           tags$li(h4("Visualisez les données réelles dans l'onglet \"Aperçu des Données\".")),
           tags$li(h4("Sélectionnez les caractéristiques des colonnes dans l'onglet \"Sélectionner les Caractéristiques\".")),
